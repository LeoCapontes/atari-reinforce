...
class ConvolutionalPong24:
    ...
    def _build_model(self):
        ...
        self.policy_network.add(Reshape((80, 80, 1), input_shape = (self.num_inputs,)))
...
class ConcatConvolutionalPong32:
    def __init__(self, num_inputs, num_outputs, optimizer):
        self.num_inputs = num_inputs
        self.num_outputs = num_outputs
        self.optimizer = optimizer
    ...
    def _build_model(self):
        ...
        reshaped_input = Reshape((80, 80, 1))(input_layer)
